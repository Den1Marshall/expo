...
- [iOS] Removed the `#available` checks that the package's own deployment target already satisfies, along with the fallbacks they guarded. (by [@Den1Marshall](https://github.com/Den1Marshall))
